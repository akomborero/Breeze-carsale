...
export default function CarDetails({ carId }: CarDetailsProps) {
  ...
  const handleWhatsAppDirect = () => {
    if (!car) return;
    const myNumber = "+263 785325250"; 
    const message = ` *New Inquiry: ${car.year} ${car.make} ${car.model}Hi WN Auto Group.! I am interested in this vehicle.. ${window.location.href}`;
          ...
          <div className="mt-auto pt-8 border-t border-gray-100">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
              <div>
                ...
                <div className="text-4xl font-black text-black italic">${car.price.toLocaleString()}</div>
              </div>
